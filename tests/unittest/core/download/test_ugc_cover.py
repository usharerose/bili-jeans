...
from bili_jeans.core.download import create_cover_task
...
async def test_create_cover_task(mock_get_req):
    ...
    assert actual_task.file == '/tmp/BV1X54y1C74U/239927346.jpg'
